...
// MySQL.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMySQLApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMySQLApp::OnAppAbout)
...
CMySQLApp::CMySQLApp() noexcept
{
	...
	SetAppID(_T("MySQL.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMySQLApp

CMySQLApp theApp;


// Инициализация CMySQLApp

BOOL CMySQLApp::InitInstance()
{
...
// Обработчики сообщений CMySQLApp
