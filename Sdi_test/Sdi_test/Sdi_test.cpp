...
// Sdi_test.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CSditestApp

CSditestApp theApp;


// Инициализация CSditestApp
...
// Обработчики сообщений CSditestApp
...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	ON_UPDATE_COMMAND_UI(ID_LINES_ROOT, &CAboutDlg::OnUpdateLinesRoot)
END_MESSAGE_MAP()
...
void CAboutDlg::OnUpdateLinesRoot(CCmdUI* pCmdUI)
{
