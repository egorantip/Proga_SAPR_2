...
// SDIProjectCourse.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSDIProjectCourseApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSDIProjectCourseApp::OnAppAbout)
...
// Создание CSDIProjectCourseApp

CSDIProjectCourseApp::CSDIProjectCourseApp() noexcept
{
	...
	SetAppID(_T("SDIProjectCourse.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSDIProjectCourseApp

CSDIProjectCourseApp theApp;


// Инициализация CSDIProjectCourseApp

BOOL CSDIProjectCourseApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSDIProjectCourseDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CSDIProjectCourseView));
	if (!pDocTemplate)
		return FALSE;
...
int CSDIProjectCourseApp::ExitInstance()
{
...
// Обработчики сообщений CSDIProjectCourseApp
...
void CSDIProjectCourseApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
